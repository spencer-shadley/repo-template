# Plan 039: Ship the tolerant secret-scan default fleet-wide, all branches (rt#302)
...
- **Status:** superseded — CEO queue hygiene 2026-09-15: linked issue #302 CLOSED COMPLETED; no fleet value keeping closed work on WorkProjection (AO#7116 / #8736)
...
low false-positive rates - `sk-` prefixes, `ghp_`, `AKIA`, PEM blocks, JWTs - and drop the fuzzy
...
- 2026-08-29T09:32:27.626Z critic-available (manual): automatic dead-letter recovery plan=039 draftHash=1500d6a750bcd03f trigger=critic-available source=critic-deadletter-retry
