...
function validateRegistryOverlay(value, expectedKind, entriesKey) {
    const diagnostics = new Diagnostics();
    const obj = parseOverlayInput(value, diagnostics);
    if (obj === undefined)
        return finish(undefined, diagnostics);
...
export function validateTechnologyRegistryOverlay(value) {
    return validateRegistryOverlay(value, "technology", "technologies");
}
export function validateComponentRegistryOverlay(value) {
    return validateRegistryOverlay(value, "component", "components");
}
