...
export const PLAN_BODY_BASENAME_PATTERN_SOURCE = String.raw `^(?!.*\.(?:[Ll][Oo][Gg]|[Rr][Ee][Ss][Uu][Ll][Tt]|[Cc][Rr][Ii][Tt][Ii][Cc]|[Ff][Ee][Ee][Dd][Bb][Aa][Cc][Kk]|[Dd][Ee][Aa][Dd][Ll][Ee][Tt][Tt][Ee][Rr])\.md$)[0-9]{3,}-[A-Za-z0-9._@()+,=-]+\.md$`;
