import { CONTRACT_ID, CONTRACT_VERSION, ENVELOPE_DIGEST_ALGORITHM, SCHEMA_DIGESTS, SCHEMA_IDS, } from "./contract.js";
...
function validatePath(value, pointer, diagnostics) {
    ...
    if (failure !== null ||
        ...
        diagnostics.add(issueOverride
            ? "E_PATH_ISSUE_TEMPLATE"
            : workflow
                ? "E_PATH_PRE_CUSTODY_WORKFLOW"
                : "E_PATH_PORTABLE", pointer, issueOverride
...
function validateReference(value, pointer, diagnostics) {
...
function validatePaths(value, pointer, diagnostics) {
