...
export function isIssueTemplateOverride(value) {
    const folded = value.toLowerCase();
    return (folded === ".github/issue_template" ||
        folded.startsWith(".github/issue_template/"));
}
export function isPreCustodyWorkflow(value) {
    const folded = value.toLowerCase();
    return (folded === ".github/workflows" ||
        folded.startsWith(".github/workflows/"));
}
export function resolvePayloadLink(sourcePath, link) {
