...
export {
  ...
  OVERLAY_CAPABILITY_BUNDLE_ID,
  PRODUCT_OVERLAY_FILE_PATH,
  TECHNOLOGY_REGISTRY_OVERLAY_FILE_PATH,
  COMPONENT_REGISTRY_OVERLAY_FILE_PATH,
  ...
  parseOverlayYaml,
  formatOverlayYaml,
  validateOverlayPayloadEntries,
} from "./product-registry-overlays-v1.ts";
export type {
  ProductOverlayRole,
  RegistryLifecycle,
  TemplateReleaseProvenance,
  BootstrapProvenance,
  PlatformRecord,
  ProductOverlay,
  CandidateEvaluation,
