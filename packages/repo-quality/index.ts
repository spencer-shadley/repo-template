 ...
 */
export const preferTypeScriptRule: Rule.RuleModule = {
  meta: {
    type: "problem",
    docs: {
      description:
...
export const noEslintInlineConfigRule: Rule.RuleModule = {
  meta: {
    type: "problem",
    docs: {
      description:
 ...
 */
export const DEFAULT_FLEET_IGNORES: readonly string[] = Object.freeze([
  "node_modules/**",
  "**/dist/**",
  "**/build/**",
  "artifacts/**",
...
export interface QualityRulesOptions {
  ...
  readonly preferTypescript?: boolean;
